...
assert (more_fuel(12) == 2)
assert (more_fuel(14) == 2)
assert (more_fuel(1969) == 966)
assert (more_fuel(100756) == 50346)

part2 = sum(more_fuel(mass) for mass in masses)
